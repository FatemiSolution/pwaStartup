...
var r=n("QILm"),a=n.n(r),o=n("Hupy"),i=["type"],s=new o.a,{documentElement:c}=globalThis.document||{},{imageOptimizingOrigin:l}=c?c.dataset:{},u="backend"===l,d=s.getItem("store_view_code")||"default",p={};[{store_code:"default",id:1,secure_base_media_url:"http://magento2.local/media/",store_name:"Default Store View",default_display_currency_code:"USD"}].forEach(e=>{p[e.store_code]=e.secure_base_media_url})
...
c.pathname.includes(l)||(c=new URL(((e,t)=>(e.endsWith("/")?e.slice(0,-1):e)+"/"+(t.startsWith("/")?t.slice(1):t))(l,e),f))}c.href.startsWith("http://magento2.local/")&&!u&&(c=new URL(c.href.slice("http://magento2.local/".length),o))
...
for(var r of("cart"===t?yield he(e):"customer"===t&&(yield ge(e)),[{store_code:"default",id:1,secure_base_media_url:"http://magento2.local/media/",store_name:"Default Store View",default_display_currency_code:"USD"}]))if(r.store_code!==n){var a=globalThis.localStorage.getItem("".concat("apollo-cache-persist","-").concat(r.store_code))
...
return Vi.reduceRight((e,t)=>a.a.createElement(t,null,e),t)},Hi=new k.a,Gi=()=>{var e=Object(Ze.g)(),t=[],n=Object(r.useMemo)(()=>({}),[]),a=Object(r.useMemo)(()=>({}),[]);[{store_code:"default",id:1,secure_base_media_url:"http://magento2.local/media/",store_name:"Default Store View",default_display_currency_code:"USD"}].forEach(e=>{t.push(e.store_code),n[e.store_code]=e.default_display_currency_code,a[e.store_code]=e.secure_base_media_url}),t.sort((e,t)=>t.length-e.length)
...
return a.a.createElement(oe.a,n,a.a.createElement(ie.a,o,a.a.createElement(se.a,i,l,a.a.createElement(Ki,null,c))))},Ji=n("kZ59"),Qi=!globalThis.document,Xi=Qi?"http://magento2.local/":globalThis.location.origin,Yi=new Set,Zi=a.a.createElement(Wi,{configureLinks:e=>[...e.values()],origin:Xi,store:ee,styles:Yi})
